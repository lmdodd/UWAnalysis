...
class CompositePtrCandidateT1T2MEtProducer : public edm::EDProducer 
{
        ...
        : algorithm_(cfg), cfgError_(0)
    {
        ...
        srcLeg1IT_ = cfg.getParameter<edm::InputTag>("srcLeg1");
        srcLeg2_ = consumes<T2View>(cfg.getParameter<edm::InputTag>("srcLeg2"));
        srcLeg2IT_ = cfg.getParameter<edm::InputTag>("srcLeg2");
    ...
    void produce(edm::Event& evt, const edm::EventSetup& es)
    {
        ...
        pf::fetchCollection(leg1Collection, srcLeg1IT_, srcLeg1_, evt);
        ...
        pf::fetchCollection(leg2Collection, srcLeg2IT_, srcLeg2_, evt);
    ...
    edm::InputTag srcLeg1IT_;
    edm::EDGetTokenT<T2View> srcLeg2_;
    edm::InputTag srcLeg2IT_;
