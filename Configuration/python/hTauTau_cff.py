...
MTanalysisConfigurator.addSelector('muTausTauLooseID','PATMuTauPairSelector','leg2.tauID("byVLooseIsolationMVArun2v1DBoldDMwLT")>0.5||leg2.userFloat("byIsolationMVArun2v1DBoldDMwLTVLooseRerun")>0.5','MTTauLooseID',1)
