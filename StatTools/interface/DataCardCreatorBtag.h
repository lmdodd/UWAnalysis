...
class DataCardCreatorBtag {
	public:

		DataCardCreatorBtag(optutl::CommandLineParser parser) {
...
/*			if (categorySelection=="NBtagPD>=1"){ 
				categorySelectionUp="NBtagPDUp>=1";
				categorySelectionDown="NBtagPDDown>=1";
			}
			else if (categorySelection=="NBtagPD==0"){
				categorySelectionUp="NBtagPDUp==0";
				categorySelectionDown="NBtagPDDown==0";
			}
*/

			tmp= createHistogramAndShiftsHiggs(dir_+"ggH125.root","ggH125",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"vbfH125.root","qqH125",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
                        std::cout<<"susyggH"<<std::endl;

			tmp= createHistogramAndShiftsHiggs(dir_+"susyggH_80.root","ggH80",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susyggH_90.root","ggH90",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susyggH_100.root","ggH100",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susyggH_110.root","ggH110",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susyggH_120.root","ggH120",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susyggH_130.root","ggH130",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susyggH_140.root","ggH140",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susyggH_160.root","ggH160",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susyggH_180.root","ggH180",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susyggH_200.root","ggH200",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susyggH_250.root","ggH250",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			//tmp= createHistogramAndShiftsHiggs(dir_+"susyggH_400.root","ggH400",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susyggH_450.root","ggH450",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susyggH_500.root","ggH500",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susyggH_600.root","ggH600",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susyggH_700.root","ggH700",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susyggH_800.root","ggH800",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susyggH_900.root","ggH900",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susyggH_1000.root","ggH1000",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susyggH_1200.root","ggH1200",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susyggH_1400.root","ggH1400",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susyggH_1500.root","ggH1500",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susyggH_1600.root","ggH1600",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susyggH_1800.root","ggH1800",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			//tmp= createHistogramAndShiftsHiggs(dir_+"susyggH_2000.root","ggH2000",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			//tmp= createHistogramAndShiftsHiggs(dir_+"susyggH_2300.root","ggH2300",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			//tmp= createHistogramAndShiftsHiggs(dir_+"susyggH_2600.root","ggH2600",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susyggH_2900.root","ggH2900",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susyggH_3200.root","ggH3200",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);


                        std::cout<<"susybbH"<<std::endl;

			tmp= createHistogramAndShiftsHiggs(dir_+"susybbH_80.root","bbH80",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susybbH_90.root","bbH90",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susybbH_100.root","bbH100",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susybbH_110.root","bbH110",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susybbH_120.root","bbH120",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susybbH_130.root","bbH130",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susybbH_140.root","bbH140",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susybbH_160.root","bbH160",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susybbH_180.root","bbH180",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			//tmp= createHistogramAndShiftsHiggs(dir_+"susybbH_200.root","bbH200",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susybbH_250.root","bbH250",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susybbH_300.root","bbH300",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susybbH_350.root","bbH350",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susybbH_400.root","bbH400",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susybbH_450.root","bbH450",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susybbH_500.root","bbH500",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susybbH_600.root","bbH600",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susybbH_700.root","bbH700",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			//tmp= createHistogramAndShiftsHiggs(dir_+"susybbH_800.root","bbH800",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susybbH_900.root","bbH900",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susybbH_1000.root","bbH1000",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susybbH_1200.root","bbH1200",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			//tmp= createHistogramAndShiftsHiggs(dir_+"susybbH_1400.root","bbH1400",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susybbH_1500.root","bbH1500",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susybbH_1600.root","bbH1600",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susybbH_1800.root","bbH1800",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susybbH_2000.root","bbH2000",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			//tmp= createHistogramAndShiftsHiggs(dir_+"susybbH_2300.root","bbH2300",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susybbH_2600.root","bbH2600",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susybbH_2900.root","bbH2900",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
			tmp= createHistogramAndShiftsHiggs(dir_+"susybbH_3200.root","bbH3200",("("+preselection+"&&"+trigSelection_+"&&"+osSignalSelection_+")"),categoryselection,luminosity_*legCorr,prefix);
		...
		BkgOutput runFullExtrapBtag(std::string relaxedSelection, std::string wSel, std::string preSelection, std::string categorySelection_, std::string prefix, std::string zShape, float topExtrap, float zExtrap, float zExtrapErr, std::string bTagSF, std::string categorySelectionData_) {
			...
			std::string categorySelectionUp = categorySelection_;
			std::string categorySelectionDown = categorySelection_;
			...
			std::pair<float,float> vvYieldUp      = createHistogramAndShifts(vvFile_,("VV_"+shiftsPostFix_[0]+"Up").c_str(),("("+preSelection+"&&"+trigSelection_+"&&"+osSignalSelection_+"&&"+categorySelectionUp+")*"+weight_),luminosity_*leg1Corr*tauID_,prefix);
			std::pair<float,float> vvYieldDown      = createHistogramAndShifts(vvFile_,("VV_"+shiftsPostFix_[0]+"Down").c_str(),("("+preSelection+"&&"+trigSelection_+"&&"+osSignalSelection_+"&&"+categorySelectionDown+")*"+weight_),luminosity_*leg1Corr*tauID_,prefix);
			...
			output.dVV = vvInflYield.second;
                        ...
                        std::cout<<"Create ZLL = ZLFT+ZJFT"<<std::endl;
			std::pair<float,float> zllYield   = createHistogramAndShifts(zllFile_,"ZLL",("("+preSelection+"&&"+trigSelection_+"&&"+osSignalSelection_+"&&"+categorySelection+"&&"+ZLL_genLLSel_+")*"+weight_),luminosity_*leg1Corr*zttScale_,prefix,false);
			std::pair<float,float> zllYieldUp   = createHistogramAndShifts(zllFile_,("ZLL_"+shiftsPostFix_[0]+"Up").c_str(),("("+preSelection+"&&"+trigSelection_+"&&"+osSignalSelection_+"&&"+categorySelectionUp+"&&"+ZLL_genLLSel_+")*"+weight_),luminosity_*leg1Corr*zttScale_,prefix,false);
			std::pair<float,float> zllYieldDown   = createHistogramAndShifts(zllFile_,("ZLL_"+shiftsPostFix_[0]+"Down").c_str(),("("+preSelection+"&&"+trigSelection_+"&&"+osSignalSelection_+"&&"+categorySelectionDown+"&&"+ZLL_genLLSel_+")*"+weight_),luminosity_*leg1Corr*zttScale_,prefix,false);
			...
			//Create ZL and ZJ
                        ...
                        std::cout<<"Create ZLFT"<<std::endl;
			//ZL Yield
			std::pair<float,float> zlftYield   = createHistogramAndShifts(zllFile_,"ZL",("("+preSelection+"&&"+trigSelection_+"&&"+osSignalSelection_+"&&"+categorySelection+"&&"+ZLFT_genLSel_+")*"+weight_),luminosity_*leg1Corr*zlftFactor_*zttScale_,prefix,false);
			std::pair<float,float> zlftYieldUp   = createHistogramAndShifts(zllFile_,("ZL_"+shiftsPostFix_[0]+"Up").c_str(),("("+preSelection+"&&"+trigSelection_+"&&"+osSignalSelection_+"&&"+categorySelectionUp+"&&"+ZLFT_genLSel_+")*"+weight_),luminosity_*leg1Corr*zlftFactor_*zttScale_,prefix,false);
			std::pair<float,float> zlftYieldDown   = createHistogramAndShifts(zllFile_,("ZL_"+shiftsPostFix_[0]+"Down").c_str(),("("+preSelection+"&&"+trigSelection_+"&&"+osSignalSelection_+"&&"+categorySelectionDown+"&&"+ZLFT_genLSel_+")*"+weight_),luminosity_*leg1Corr*zlftFactor_*zttScale_,prefix,false);
			std::pair<float,float> zlftInflYield  = inflateError(zlftYield,zlftErr_);
			printf("      Z (l->tau) in signal region = %f + %f \n",zlftInflYield.first,zlftInflYield.second);
			...
			output.dZLFT  = zlftInflYield.second;
                        ...
                        std::cout<<"Create ZJFT"<<std::endl;
			//ZJ Yield
			std::pair<float,float> zjftYield      = createHistogramAndShifts(zllFile_,"ZJ",("("+preSelection+"&&"+trigSelection_+"&&"+osSignalSelection_+"&&"+categorySelection+"&&"+ZJFT_genLReject_+")*"+weight_),luminosity_*leg1Corr*zttScale_,prefix);    
			std::pair<float,float> zjftYieldUp      = createHistogramAndShifts(zllFile_,("ZJ_"+shiftsPostFix_[0]+"Up").c_str(),("("+preSelection+"&&"+trigSelection_+"&&"+osSignalSelection_+"&&"+categorySelectionUp+"&&"+ZJFT_genLReject_+")*"+weight_),luminosity_*leg1Corr*zttScale_,prefix);    
			std::pair<float,float> zjftYieldDown      = createHistogramAndShifts(zllFile_,("ZJ_"+shiftsPostFix_[0]+"Down").c_str(),("("+preSelection+"&&"+trigSelection_+"&&"+osSignalSelection_+"&&"+categorySelectionDown+"&&"+ZJFT_genLReject_+")*"+weight_),luminosity_*leg1Corr*zttScale_,prefix);    
			...
			if(!runZTT(preSelection, prefix, zShape, topExtrap, output, categorySelection,relaxedSelection,categorySelectionUp,categorySelectionDown)){
				std::cout<<"Error Creating Ztt"<<std::endl;
				return output;
			}
			...
			if(!runTOP(preSelection, prefix, zShape, topExtrap, output, categorySelection, relaxedSelection,categorySelectionUp,categorySelectionDown)){
				...
				return output;
                        ...
                        std::cout<<"Create W"<<std::endl;
			//Create W
			if(!runW(preSelection, prefix, zShape, topExtrap, output, categorySelection, relaxedSelection, wSel,categorySelectionUp,categorySelectionDown)){
				std::cout<<"Error Creating W"<<std::endl;
				return output;
			}
                        ...
                        std::cout<<"Create QCD"<<std::endl;
			//Create QCD
			if(!runQCD(preSelection, prefix, zShape, topExtrap, output, categorySelection, relaxedSelection,categorySelectionUp,categorySelectionDown)){
				std::cout<<"Error Creating QCD"<<std::endl;
				return output;
			}
		...
		bool runZTT(std::string preSelection,std::string prefix,std::string zShape, float topExtrap, BkgOutput &output,
				std::string categorySelection = "pt_1>-100", std::string relaxedSelection = "pt_1>-100",std::string categorySelectionUp = "pt_1>-100",std::string categorySelectionDown = "pt_1>-100"){
			...
			std::pair<float,float> zttUp  = createHistogramAndShifts(zttFile_,("ZTT_"+shiftsPostFix_[0]+"Up").c_str(),("("+preSelection+"&&"+trigSelection_+"&&"+osSignalSelection_+"&&"+categorySelectionUp+"&&"+ZTT_genTauSel_+")*"+weight_),luminosity_*zttScale_*leg1Corr*tauID_,prefix);
			std::pair<float,float> zttDown  = createHistogramAndShifts(zttFile_,("ZTT_"+shiftsPostFix_[0]+"Down").c_str(),("("+preSelection+"&&"+trigSelection_+"&&"+osSignalSelection_+"&&"+categorySelectionDown+"&&"+ZTT_genTauSel_+")*"+weight_),luminosity_*zttScale_*leg1Corr*tauID_,prefix);
		...
		bool runTOP( std::string preSelection, std::string prefix, std::string zShape, float topExtrap, BkgOutput &output, 
				std::string categorySelection, std::string relaxedSelection,std::string categorySelectionUp = "pt_1>-100",std::string categorySelectionDown = "pt_1>-100" ) {
			...
			std::pair<float,float> topShapeUp      = createHistogramAndShifts(topFile_,("TT_"+shiftsPostFix_[0]+"Up").c_str(),("("+preSelection+"&&"+trigSelection_+"&&"+osSignalSelection_+"&&"+categorySelectionUp+")*"+weight_), luminosity_*leg1Corr*tauID_*topExtrap, prefix);
			std::pair<float,float> topShapeDown      = createHistogramAndShifts(topFile_,("TT_"+shiftsPostFix_[0]+"Down").c_str(),("("+preSelection+"&&"+trigSelection_+"&&"+osSignalSelection_+"&&"+categorySelectionDown+")*"+weight_), luminosity_*leg1Corr*tauID_*topExtrap, prefix);
		...
		bool runQCD(std::string preSelection, std::string prefix, std::string zShape, float topExtrap, BkgOutput &output, std::string categorySelection, std::string relaxedSelection,std::string categorySelectionUp = "pt_1>-100",std::string categorySelectionDown = "pt_1>-100") 
		{
			float leg1Corr=1.0;
			if(muID_!=0) leg1Corr*=muID_;
			if(eleID_!=0) leg1Corr*=eleID_;
			...
			std::pair<float,float> dataQCDUp = createHistogramAndShifts(dataFile_,("QCD_"+shiftsPostFix_[0]+"Up").c_str(),"("+preSelection_+"&&"+trigSelection50ns_+"&&"+ssSignalSelection_+"&&"+categorySelection+")",scaleUp_,prefix); 
			std::pair<float,float> dataQCDDown = createHistogramAndShifts(dataFile_,("QCD_"+shiftsPostFix_[0]+"Down").c_str(),"("+preSelection_+"&&"+trigSelection50ns_+"&&"+ssSignalSelection_+"&&"+categorySelection+")",scaleUp_,prefix); 
			...
			std::pair<float,float> ZQCDUp = createHistogramAndShifts(zttFile_,"ZQCDUp","("+preSelection_+"&&"+trigSelection_+"&&"+ssSignalSelection_+"&&"+categorySelectionUp+")*"+weight_,luminosity_,prefix); 
			std::pair<float,float> ZQCDDown = createHistogramAndShifts(zttFile_,"ZQCDDown","("+preSelection_+"&&"+trigSelection_+"&&"+ssSignalSelection_+"&&"+categorySelectionDown+")*"+weight_,luminosity_,prefix); 
			...
			std::pair<float,float> TopQCDUp = createHistogramAndShifts(topFile_,"TopQCDUp","("+preSelection_+"&&"+trigSelection_+"&&"+ssSignalSelection_+"&&"+categorySelectionUp+")*"+weight_,luminosity_,prefix); 
			std::pair<float,float> TopQCDDown = createHistogramAndShifts(topFile_,"TopQCDDown","("+preSelection_+"&&"+trigSelection_+"&&"+ssSignalSelection_+"&&"+categorySelectionDown+")*"+weight_,luminosity_,prefix); 
			...
			std::pair<float,float> VVQCDUp       = createHistogramAndShifts(vvFile_,"VVQCDUp",("("+preSelection_+"&&"+trigSelection_+"&&"+ssSignalSelection_+"&&"+categorySelectionUp+")*"+weight_),luminosity_,prefix,false);
			std::pair<float,float> VVQCDDown       = createHistogramAndShifts(vvFile_,"VVQCDDown",("("+preSelection_+"&&"+trigSelection_+"&&"+ssSignalSelection_+"&&"+categorySelectionDown+")*"+weight_),luminosity_,prefix,false);
			...
			std::pair<float,float> ssWLowUp       = createHistogramAndShifts(wFile_,"WQCDUp",("("+preSelection_+"&&"+trigSelection_+"&&"+ssSignalSelection_+"&&"+categorySelectionUp+")*"+weight_),luminosity_*leg1Corr,prefix,false);
			std::pair<float,float> ssWLowDown       = createHistogramAndShifts(wFile_,"WQCDDown",("("+preSelection_+"&&"+trigSelection_+"&&"+ssSignalSelection_+"&&"+categorySelectionDown+")*"+weight_),luminosity_*leg1Corr,prefix,false);
		...
		bool runW(std::string preSelection,std::string prefix,std::string zShape, float topExtrap, BkgOutput &output, std::string categorySelection, std::string relaxedSelection, std::string wSel,std::string categorySelectionUp = "pt_1>-100",std::string categorySelectionDown = "pt_1>-100") {
			...
			std::pair<float,float> wYieldUp         = createHistogramAndShifts(wFile_,("W_"+shiftsPostFix_[0]+"Up").c_str(),("("+preSelection+"&&"+trigSelection_+"&&"+osSignalSelection_+"&&"+categorySelectionUp+")*"+weight_),luminosity_*leg1Corr,prefix,false);
			std::pair<float,float> wYieldDown         = createHistogramAndShifts(wFile_,("W_"+shiftsPostFix_[0]+"Down").c_str(),("("+preSelection+"&&"+trigSelection_+"&&"+osSignalSelection_+"&&"+categorySelectionDown+")*"+weight_),luminosity_*leg1Corr,prefix,false);
		...
		std::pair<float,float> createHistogramAndShiftsHiggs(std::string file,std::string name, std::string cut, std::string catShift, float scaleFactor = 1, std::string postfix = "",bool normUC  = true, bool keys=false,bool ShapeUncertainty=true) {
			TFile *f  = new TFile(file.c_str());
			if(f==0) printf("Not file Found\n");
			//get the nominal tree first
			TTree *t= (TTree*)f->Get((channel_+"EventTree/eventTree").c_str());
			...
			if(!keys)
				yield =makeHistogram(t,filelabel_+postfix,name,"("+cut+"&&"+catShift+")*"+weight_,scaleFactor);
			else
				yield =makeTHKeys(t,filelabel_+postfix,name,"("+cut+"&&"+catShift+")*"+weight_,scaleFactor);

			//now the shifts
			std::pair<float,float> tmpYield;
			for(unsigned int i=0;i<shifts_.size();++i) {
			std::string catShiftUp=catShift;
			std::string catShiftDown=catShift;
			if (catShift=="NBtagPD>=1"){ 
				catShiftUp="NBtagPDUp>=1";
				catShiftDown="NBtagPDDown>=1";
			}
			else if (catShift=="NBtagPD==0"){
				catShiftUp="NBtagPDUp==0";
				catShiftDown="NBtagPDDown==0";
			}
				...
				if(ts!=0) {
					if(!keys)
						tmpYield = makeHistogram(ts,filelabel_+postfix,name+"_"+shiftsPostFix_[i]+"Up","("+cut+"&&"+catShiftUp+")*"+weight_,scaleFactor);
					else
						tmpYield = makeTHKeys(ts,filelabel_+postfix,name+"_"+shiftsPostFix_[i]+"Up","("+cut+"&&"+catShiftUp+")*"+weight_,scaleFactor);
				...
				if(ts!=0) {
					if(!keys)
						tmpYield = makeHistogram(ts,filelabel_+postfix,name+"_"+shiftsPostFix_[i]+"Down","("+cut+"&&"+catShiftDown+")*"+weight_,scaleFactor);
					else
						tmpYield = makeTHKeys(ts,filelabel_+postfix,name+"_"+shiftsPostFix_[i]+"Down","("+cut+"&&"+catShiftDown+")*"+weight_,scaleFactor);
