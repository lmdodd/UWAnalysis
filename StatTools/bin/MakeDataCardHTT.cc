...
int main (int argc, char* argv[]) 
{
	...
	printf(" -------------------------------------\n"); 
		...
		BkgOutput outputIncl = creator.runFullExtrapBtag(inclSel,parser.stringValue("wselection"),inclSel,catSel,"_antibtag",parser.stringValue("zEmbeddedSample"),parser.doubleValue("topSF"),
				1,//parser.doubleValue("zExtrap"),
				1,//parser.doubleValue("zExtrapErr"),
				bTagSF, //parser.stringValue("bTagSF");
				catDataSel
